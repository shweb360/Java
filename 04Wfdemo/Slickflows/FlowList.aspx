            ...
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <li><a href="javascript:;" onclick="tabs(this);">我经办的流程</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <asp:Repeater ID="Repeater2" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <a href="javascript:ShowFlowOpinion('<%#Eval("AppName") %>',<%#Eval("AppInstanceID") %>)">查看流程</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                <a href="/WfDesigner/Diagram?ProcessGUID=<%#Eval("ProcessGUID") %>&Version=<%#Eval("Version") %>&AppInstanceID=<%#Eval("AppInstanceID") %>" target="_blank">流程图信息</a>&nbsp;&nbsp;|&nbsp;&nbsp;                                
                                <a href="<%# GoApprovalPage(Eval("AppName").ToString()) %>?ProcessGUID=<%#Eval("ProcessGUID") %>&AppInstanceID=<%#Eval("AppInstanceID") %>&ActivityInstanceID=<%#Eval("ActivityInstanceID") %>&TaskID=<%#Eval("TaskID") %>">办理</a>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <a href="javascript:ShowFlowOpinion('<%#Eval("AppName") %>',<%#Eval("AppInstanceID") %>)">查看流程</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                <a href="/WfDesigner/Diagram?ProcessGUID=<%#Eval("ProcessGUID") %>&Version=<%#Eval("Version") %>&AppInstanceID=<%#Eval("AppInstanceID") %>" target="_blank">流程图信息</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                 <a href="<%# GoInfoPage(Eval("AppName").ToString()) %>?AppInstanceID=<%#Eval("AppInstanceID") %>">申请信息</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
                ...
                <asp:Repeater ID="RepeaterALL" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="left"><%#Eval("CreatedByUserName") %></td>
                            <td align="left"><%#Eval("CreatedDateTime") %></td>
                            <td align="left"><%#Slickflow.WebDemo.Common.EnumHelper.GetDescription(typeof(Slickflow.WebDemo.Common.ProcessStateEnum),Convert.ToInt32(Eval("TaskState"))) %></td>
                            <td align="center">
                                <a href="javascript:ShowFlowOpinion('<%#Eval("AppName") %>',<%#Eval("AppInstanceID") %>)">查看流程</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                <a href="/WfDesigner/Diagram?ProcessGUID=<%#Eval("ProcessGUID") %>&AppInstanceID=<%#Eval("AppInstanceID") %>" target="_blank">流程图信息</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                <a href="<%# GoInfoPage(Eval("AppName").ToString()) %>?AppInstanceID=<%#Eval("AppInstanceID") %>">申请信息</a>
                            </td>
                        </tr>
                    </ItemTemplate>
...
<script type="text/javascript">
    function ShowFlowOpinion(AppName,AppInstanceID) {
        $.layer({
            type: 2,
            closeBtn: [0, true],
            shadeClose: false,
            ...
            area: ['720px', '500px'],
            title: "查看流程详细办理步骤",
            iframe: { src: 'FlowOpinion.aspx?AppName=' + AppName + '&AppInstanceID=' + AppInstanceID },
