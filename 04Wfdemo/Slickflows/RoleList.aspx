<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleList.aspx.cs" Inherits="Slickflow.WebDemo.Slickflows.RoleList" %>
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">角色列表</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <asp:Repeater ID="RepRoleList" runat="server">
                    <ItemTemplate>
                      ...
                      <%--      <td align="center">
                            ...
                            <td align="left"><%#Eval("RoleCode") %></td>
                            <td align="left"><%#Eval("RoleName") %></td>                           
                            <td align="center">
                                <a href="javascript:ShowRoleOpinion(<%#Eval("ID") %>)">编辑详细</a>&nbsp;&nbsp;<%--|&nbsp;&nbsp;                               
                                <a href="#">菜单权限</a>--%>
                            </td>
                        </tr>
                    </ItemTemplate>
