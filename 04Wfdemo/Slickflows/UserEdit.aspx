<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEdit.aspx.cs" Inherits="Slickflow.WebDemo.Slickflows.UserEdit" %>
...
<form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>用户名</dt>
                <dd>
                    <input runat="server" type="text" id="TxtLoginName" class="input normal"/>
            ...
            <dl>
                <dt>初始密码</dt>
                <dd>
                    <input runat="server" type="text" id="TxtPassword" class="input normal" />
                </dd>
            </dl>
            <dl>
                <dt>再输一次</dt>
                <dd>
                    <input runat="server" type="text" id="TxtRePassword" class="input normal" />
                </dd>
            </dl>
             <dl>
                <dt>姓名</dt>
                <dd>
                    <input runat="server" type="text" id="TxtUserName" class="input normal" />
            ...
            <dl>
                <dt>手机</dt>
                <dd>
                    <input runat="server" type="text" id="TxtMobile" class="input normal" />
                </dd>
            </dl>
           <dl>
                <dt>邮箱</dt>
                <dd>
                    <input runat="server" type="text" id="TxtEMail" class="input normal" />
                </dd>
            </dl>
             <dl>
                <dt>工作证卡号</dt>
                <dd>
                    <input runat="server" type="text"  id="TxtCardID" class="input normal" />
                </dd>
            </dl>
            <dl>
                <dt>用户角色</dt>
