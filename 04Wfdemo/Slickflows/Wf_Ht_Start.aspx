<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wf_Ht_Start.aspx.cs" Inherits="Slickflow.WebDemo.Slickflows.Wf_Ht_Start" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>甲方</dt>
                <dd>
                    <input runat="server" type="text" value="上海市建设工程安全质量监督总站" id="txtPartyA" class="input normal" />
            ...
            <dl>
                <dt>合同签订日期</dt>
                <dd>
                    <input runat="server" type="text" value="" id="txtSigningDate" class="input normal Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="cursor: pointer" />
                </dd>
            </dl>
             <dl>
                <dt>合同期限</dt>
            ...
            <dl>
                <dt>合同金额</dt>
                <dd>
                    <input runat="server" type="text" value="" id="txtAmount" class="input normal"  style="width:100px" onblur="checkAmount()" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')"/> 元 &nbsp;&nbsp;&nbsp;&nbsp;<span id="spinfo" style="color:red"></span>
                </dd>
            </dl>
             <dl>
                <dt>合同备注</dt>
     ...
     <script type="text/javascript">
         ...
         function checkAmount() {
             if ($("#selectApplyType").val() == 1 && $("#txtAmount").val() > 50000) {
                 $("#spinfo").html("注：采购合同大于5万需要党委会审议");
             }
             else if (($("#selectApplyType").val() != 0 && $("#selectApplyType").val() != 1) && $("#txtAmount").val() > 100000) {
                 $("#spinfo").html("注：" + $("#selectApplyType").find("option:selected").text() + "大于10万需要党委会审议");
             }
