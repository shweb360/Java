<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wf_Ygkq_Approval.aspx.cs" Inherits="Slickflow.WebDemo.Slickflows.Wf_Ygkq_Approval" %>
        ...
        <div class="tab-content">
            ...
            <dl>
             ...
             <dl>
                <dt>开始日期</dt>
                <dd>
                    <input runat="server" type="text" value="" id="txtFromDate" class="input normal Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="cursor: pointer" />
                </dd>
            </dl>
            <dl>
                <dt>结束日期</dt>
                <dd>
                    <input runat="server" type="text" value="" id="txtToDate" class="input normal Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="cursor: pointer" /></dd>
            </dl>
...
                        <td><a href="<%#Eval("FilePath").ToString().Replace("~","")%>">下载</a></td>    
                    </tr>           
                </table>
                </ItemTemplate>
            </asp:Repeater>
           ...
           <dl>
             ...
             <dl>
                ...
                <dd>
                    ...
                    <asp:Label ID="LzRemark" runat="server"></asp:Label><br />   
