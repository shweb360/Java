<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wf_Ygkq_Start.aspx.cs" Inherits="Slickflow.WebDemo.Slickflows.Wf_Ygkq_Start" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>开始日期</dt>
                <dd>
                    <input runat="server" type="text" value="" id="txtFromDate" class="input normal Wdate" onfocus="WdatePicker()" style="cursor: pointer" />
                </dd>
            </dl>
            <dl>
                <dt>结束日期</dt>
                <dd>
                    <input runat="server" type="text" value="" id="txtToDate" class="input normal Wdate" onfocus="WdatePicker()" style="cursor: pointer" /></dd>
            </dl>
             <dl>
