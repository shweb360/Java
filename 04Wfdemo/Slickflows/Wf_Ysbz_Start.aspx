<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wf_Ysbz_Start.aspx.cs" Inherits="Slickflow.WebDemo.Slickflows.Wf_Ysbz_Start" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
   <title>预算编制流程发起</title>
   ...
   <script>
       ...
       function SeleteFlowInfo() {
           ...
           $.layer({
               ...
               area: ['420px', '410px'],
               title: "转下一步.选择步骤及办理人",
               iframe: { src: 'FlowStepSelect.aspx?Step=start&ProcessGUID=' + ProcessGUID + "&condition=flag-1" },
