<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wf_Ystz_Approval.aspx.cs" Inherits="Slickflow.WebDemo.Slickflows.Wf_Ystz_Approval" %>
...
                </ItemTemplate>
           ...
           <dl>
               <dt data-options="field:'state'"></dt>
             <dd>
                ...
                <asp:Label ID="CwRemark" runat="server"></asp:Label><br />
