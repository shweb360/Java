...
{
    public partial class Wf_Ystz_Start : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                txtProcessGUID.Value = Wf_Ystz_ProcessConfig[0].ToString();
                if (LoginRoleID > 0)
                {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string processGUID = Wf_Ystz_ProcessConfig[0].ToString();
                ...
                financialEntity.FinancialType = 3;
                try
                {
